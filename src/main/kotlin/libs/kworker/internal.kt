...
internal val ENVIRONMENT_IS_NODE: Boolean by lazy { js("(typeof process === 'object' && typeof require === 'function')") as Boolean }
internal val ENVIRONMENT_IS_WEB: Boolean by lazy { js("(typeof window === 'object')") as Boolean }
internal val ENVIRONMENT_IS_WORKER: Boolean by lazy { js("(typeof importScripts === 'function')") as Boolean }
internal val ENVIRONMENT_IS_WEB_OR_WORKER: Boolean by lazy {
